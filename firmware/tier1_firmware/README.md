# `firmware/tier1_firmware/` — Tier 1, Arduino Uno (the Tier 2 owner)

`tier1_firmware.ino` goes here. It is **not** in the repo yet because it is the Tier 2 owner's deliverable,
